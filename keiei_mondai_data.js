...
const KEIEI_PROBLEMS_FINANCE1 = [
  ...
  },
  {
    ...
    items: mkItems("finance1__1-42", [
      { label: "問1 単利計算による現在価値・将来価値", imp: "C-C", rotationLeft: null, rotationRight: null, flags: ["1回 or 不要-不要"] },
      { label: "問2 マイナス金利下の債券現在価値算定", imp: "C-C", rotationLeft: null, rotationRight: null, flags: ["1回 or 不要-不要"] },
...
const KEIEI_PROBLEMS_FINANCE2 = [
  ...
  },
  {
    ...
    items: buildKeywordItems("finance2__2-24", [
      ...
      [51, "日経平均採用銘柄の株価水準", "B-B"], [52, "リターンリバーサル", "B-B", 1], [53, "モメンタム", "B-B", 1],
      ...
      [72, "マルチファクター・モデル", "B-B", 1], [73, "APT（裁定価格理論）", "B-B"], [74, "3ファクター・モデル", "B-B"],
  ...
  },
  {
    ...
    items: mkItems("finance2__2-25", [
      ...
      { label: "問1(4) 空欄⑥⑦", imp: "B-C+", rotationLeft: 2, rotationRight: 1, flags: ["キーワード"] },
